...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_e, spawn, SHCMD("nvim")},
    {MODKEY, XK_m, spawn, SHCMD("sh ~/.config/chadwm/scripts/kblayout.sh")},
    // {MODKEY | ShiftMask, XK_Return, spawn, SHCMD("rofi -show drun")},
    {MODKEY | Mod1Mask, XK_Return, spawn,
     SHCMD("rofi -config ~/.config/chadwm/rofi/config.rasi -show run")},
    {ALTKEY, XK_Tab, spawn,
     SHCMD("rofi -config ~/.config/chadwm/rofi/config.rasi -show window")},
    {MODKEY, XK_d, spawn,
     SHCMD("rofi -config ~/.config/chadwm/rofi/config.rasi -show drun")},
